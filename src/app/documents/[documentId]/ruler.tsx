...
export const Ruler = () => {
      ...
      if (container) {
        ...
        if (isDraggingLeft) {
          ...
          const newRightPosition = Math.min(
            Math.max(PAGE_WIDTH - rawPosition, 0),
            maxRightPosition
          );
  ...
  return (
    ...
    >
      <div
        id="ruler-container"
        className="relative max-w-[816px] mx-auto w-full h-full"
      >
        <Marker
          position={leftMargin}
          isLeft={true}
...
const Marker = ({
  ...
  return (
    <div
      className="absolute top-0 w-4 h-full cursor-ew-resize z-[5] group -ml-2 -mr-2"
